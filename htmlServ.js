...
routeTable = {
    //get HTML页面
    '/list/' : (req, res) => {
        readFiles("./pages/chapterList.html",'text/html; charset=utf8',res);
    },
    '/detail': (req,res) => {
        readFiles("./pages/chapter.html",'text/html; charset=utf8',res);
    },  
    '/login/': (req,res) => {
        readFiles("./pages/login.html",'text/html; charset=utf8',res);
    },
    '/listmanager/': (req,res) => {
        readFiles("./pages/list.html",'text/html; charset=utf8',res);
    },
    '/addChapter/': (req,res) => {
        readFiles("./pages/addChapter.html",'text/html; charset=utf8',res);
    },

    //get 静态文件 
    '/list/css/base.css' : (req, res) => {
        readFiles("./pages/css/base.css","text/css",res);
    },
    '/css/base.css' : (req, res) => {
        readFiles("./pages/css/base.css","text/css",res);
    },
    '/list/css/style.css': (req,res) => {
        readFiles("./pages/css/style.css","text/css",res);
    },
    '/css/new.css': (req,res) => {
        readFiles("./pages/css/new.css","text/css",res);
    },
    '/list/js/baiduTemplate.js': (req,res) => {
        readFiles("./pages/js/baiduTemplate.js","application/javascript",res); 
    },
    '/listmanager/js/baiduTemplate.js': (req,res) => {
        readFiles("./pages/js/baiduTemplate.js","application/javascript",res); 
    },
            ...
            req.on('end',function(data){
                ...
                if(title != '' && content != ''){
                    blog = {
                        "chapterId": 1,
                        "chapterName": title,
                        "imgPath": "images/1433935839731755-lp.png",
                        "chapterDes": content,
                        "chapterContent":content,
                        "author": "admin",
                        "views": 0
                    }
                    for(var i = chapterList.length;i >= 0;i--){
                        if(i != 0){
                            chapterList[i] = chapterList[i-1];
                            chapterList[i].chapterId++;
                        }else{
                            chapterList[0] = blog;
                        }
                    }
    ...
    //get 图片
    '/list/images':(req,res) => { //list网页 url解析字符串获取路径
        let path = req.url.split('?');
        let name = path[1];
        readImg('./pages/images/'+name,res);
    },
    '/images/1447642096207160.png':(req,res) => { //detail
        readImg('./pages/images/1447642096207160.png',res);
    },
    '/login/login_bg.jpg':(req,res) => {  //login
        readImg('./pages/login_bg.jpg',res);
    },
    '/list/images/img/r_line.jpg':(req,res) => {   // images/img 背景图片
        readImg('./pages/images/img/r_line.jpg',res);
    },
    '/images/img/r_line.jpg': (req,res) => {   // images/img 背景图片
        readImg('./pages/images/img/r_line.jpg',res);
    },
    '/images/img/6264.png':(req,res) => {
        readImg('./pages/images/img/6264.png',res);
    },
    '/list/images/img/h_line.jpg':(req,res) => {
        readImg('./pages/images/img/h_line.jpg',res);
    },
    '/list/images/img/time.jpg':(req,res) => {
        readImg('./pages/images/img/time.jpg',res);
    },
    '/list/images/img/newsbg03.png': (req,res) => {
        readImg('./pages/images/img/newsbg03.png',res);
    }
};
